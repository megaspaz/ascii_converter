...
/**
 * <p>
 * Title: Ascii To Binary/Binary To Ascii Converter
 * </p>
 * <p>
 * Description: Converts Ascii Input to Binary and Binary Input to Ascii
 * </p>
 * <p>
 * Package/Class: atobtoa.frmAbout
 * </p>
 * <p>
...
public class frmAbout extends JDialog implements ActionListener {
  ...
  private void jbInit() throws Exception {
    ...
    label1.setText("Ascii Converter");
    label2.setBackground(Color.white);
    label2.setFont(new java.awt.Font("Dialog", 3, 16));
    label2.setForeground(Color.blue);
    label2.setHorizontalAlignment(SwingConstants.CENTER);
    label2.setHorizontalTextPosition(SwingConstants.CENTER);
    label2.setText("Version 4.5");
    label3.setBackground(Color.white);
    label3.setFont(new java.awt.Font("Dialog", 3, 16));
    ...
    panel1.setMaximumSize(new Dimension(350, 148));
    panel1.setMinimumSize(new Dimension(350, 148));
    panel1.setPreferredSize(new Dimension(350, 148));
    insetsPanel1.setBackground(Color.white);
    jLabel1.setFont(new java.awt.Font("Monospaced", 1, 12));
    jLabel1.setForeground(Color.blue);
    jLabel1.setHorizontalAlignment(SwingConstants.CENTER);
    jLabel1.setHorizontalTextPosition(SwingConstants.CENTER);
    jLabel1.setText("Copyright (c) 2002");
